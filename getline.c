...
/**
 * fn_reset_sz - Reallocates a memory block using malloc and free.
...
/**
 * assign_lineptr - Reassigns the lineptr variable for fn_get_ln.
...
/**
 * fn_get_ln - Reads input from a stream.
